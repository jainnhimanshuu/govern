                        ...
                        <div className="row align-items-end">
                            ...
                            <div className="col-xl-6">
                                <div className="box-banner-right-home6">
                                    ...
                                    <h1 className="color-brand-1 mb-20 mt-5">Innovative Solution to Move Your Business Forward</h1>
                                    <div className="row">
                                        <div className="col-lg-10">
                                            <p className="font-md color-grey-500 mb-30">Collaborate, plan projects and manage resources with powerful features that your whole team can use. The latest news, tips and advice to help you run your business with less fuss.</p>
                                        </div>
                                    </div>
                                    <div className="mt-30">
