                        ...
                        <div className="banner-1">
                            <div className="row align-items-center">
                                <div className="col-lg-7">
                                    <h1 className="color-brand-1 mb-20">The data layer between your<span className="line-under"><span> business</span></span> and its potential.</h1>
                                    <div className="row">
                                        <div className="col-lg-9">
                                            <p className="font-md color-grey-500 mb-30">Optimize write performance with a document data model that maps to your application’s access patterns. Meet a wide range of query requirements via a single query API that supports everything from simple lookups to complex processing pipelines for data analytics and transformations.</p>
                                        </div>
                                    </div>
                                    <div className="box-button mt-30"><Link className="btn btn-brand-1 hover-up" href="#">Download App</Link><a className="btn btn-default font-sm-bold hover-up" href="#">Learn More
                ...
                <section className="section mt-50 mb-30">
                    <div className="container">
                        <div className="text-center mb-70">
                            <h2 className="color-brand-1 mb-20">High quality projects finished and awarded <br className="d-none d-xl-block" />on conferences around the globe.</h2>
                        </div>
                        <div className="row mt-50 mb-100">
                            ...
                            <div className="col-xl-5 col-lg-6"> <span className="btn btn-tag">Business</span>
