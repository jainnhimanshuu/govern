...
const HomePage1 = () => {
  ...
  return (
    <>
      <Head>
        <title>GovernAgent | The AI-Powered Compliance Solution</title>
      </Head>
                  ...
                  <div className="row">
                    <div className="col-lg-9">
                      <p className="font-md color-grey-500 mb-30">
                        Reduce risk, increase efficiency, and focus on growth
                        with our intelligent platform designed for complex legal
            ...
            <div className="row mb-100 mt-50 project-revert">
              <div className="col-xl-5 col-lg-6">
                ...
                <p className="font-md color-grey-400">
                  ...
                  that reflects your personal values and professional skills.
                  Even if you only use social media occasionally, what you
                  create, share or react to feeds into this public narrative.
                  How you conduct yourself online is now just as important as
                  your behavior offline especially when it comes to your digital
                  marketing career.
                </p>
                <div className="mt-20">
                  <ul className="list-ticks">
                ...
                <div className="card-blog-grid hover-up">
                  ...
                  <div className="card-info">
                    ...
                    <p className="font-sm color-grey-500 mt-20">
                      ...
                      risus. Fusce varius vel velit commodo consectetur. Aliquam
                      sodales posuere neque, eget placerat libero fermentum nec.
                      Fusce malesuada laoreet enim, ut convallis odio eleifend
                      vitae.
                    </p>
